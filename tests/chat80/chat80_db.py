...
db.import_csv('sea', path + "/resources/sea.csv")
db.import_csv('river', path + "/resources/river.csv")
db.import_csv('city', path + "/resources/city.csv")
...
db.insert(Record('country', {'id': 'india', 'region': 'indian_subcontinent', 'lat': 20, 'long': -80, 'area': 1229.919, 'population': 574.220, 'capital': 'new_delhi', 'currency': 'rupee'}))
db.insert(Record('country', {'id': 'turkey', 'region': 'middle_east', 'lat': 39, 'long': -36, 'area': 301.380, 'population': 37.930, 'capital': 'ankara', 'currency': 'lira'}))
...
# db.insert(Record('sea', {'id': 'mediterranean'}))   
