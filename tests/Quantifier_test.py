...
def vp_no_sub(aux, qp, child):
    return lambda sub: find(
        (qp, child),
        lambda sub2: [r.values['child'] for r in db.match(Record('has_child', {'parent': sub}))])
...
class TestQuantifier(unittest.TestCase):
    ...
    def test_quantifier(self):
        ...
        grammar = [
            ...
            { "syn": "vp_no_sub -> aux qp child", "sem": vp_no_sub },
