...
class PAMModule(SomeModule):
    ...
    def __init__(self, data_source: SomeDataSource) -> None:
        ...
        self.add_relation(Relation("lost", query_function=self.resolve_name))
        self.add_relation(Relation("farmer", query_function=self.resolve_name))
        self.add_relation(Relation("stand", query_function=self.resolve_name))
        self.add_relation(Relation("side", query_function=self.resolve_name))
        self.add_relation(Relation("road", query_function=self.resolve_name))
        self.add_relation(Relation("of", query_function=self.resolve_name))
        self.add_relation(Relation("by", query_function=self.resolve_name))
        self.add_relation(Relation("to", query_function=self.resolve_name))
        self.add_relation(Relation("ask", query_function=self.resolve_name))
        self.add_relation(Relation("be", query_function=self.resolve_name))
